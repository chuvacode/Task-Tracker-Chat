...
const ChatHeader: FC<Props> = ({name, description, selectedMessageIDs, allUnselect, deleteMessages}) => {
        ...
        <div className={Style.chatWindowHeader}>
          <div className={Style.actions}>
            <div className={Style.counter}>
              ...
              <button className={Style.btn} onClick={allUnselect}/>
            </div>

            <button className={Style.btnDelete} onClick={deleteMessages}>
